...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('QuickStart-1.0.0/assets/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('QuickStart-1.0.0/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('QuickStart-1.0.0/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('QuickStart-1.0.0/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('QuickStart-1.0.0/assets/vendor/aos/aos.css') }}" rel="stylesheet">
    <link href="{{ asset('QuickStart-1.0.0/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('QuickStart-1.0.0/assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">

    <!-- Main CSS File -->
    <link href="{{ asset('QuickStart-1.0.0/assets/css/main.css') }}" rel="stylesheet">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="{{ route('index') }}" class="logo d-flex align-items-center me-auto">
                <img src="{{ asset('QuickStart-1.0.0/assets/img/logo.png') }}" alt="">
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section">
            <div class="hero-bg">
                <img src="{{ asset('QuickStart-1.0.0/assets/img/hero-bg-light.webp') }}" alt="">
            </div>
            <div class="container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <img src="{{ asset('QuickStart-1.0.0/assets/img/hero-services-img.webp') }}"
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
                        <div class="row gy-4">
                            <div class="col-lg-6">
                                <img src="{{ asset('QuickStart-1.0.0/assets/img/about-company-1.jpg') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="row gy-4">
                                    <div class="col-lg-12">
                                        <img src="{{ asset('QuickStart-1.0.0/assets/img/about-company-2.jpg') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                    <div class="col-lg-12">
                                        <img src="{{ asset('QuickStart-1.0.0/assets/img/about-company-3.jpg') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="tab-pane fade active show" id="features-tab-1">
                                <img src="{{ asset('QuickStart-1.0.0/assets/img/tabs-1.jpg') }}" alt=""
                                    class="img-fluid">
                            </div><!-- End Tab Content Item -->

                            <div class="tab-pane fade" id="features-tab-2">
                                <img src="{{ asset('QuickStart-1.0.0/assets/img/tabs-2.jpg') }}" alt=""
                                    class="img-fluid">
                            </div><!-- End Tab Content Item -->

                            <div class="tab-pane fade" id="features-tab-3">
                                <img src="{{ asset('QuickStart-1.0.0/assets/img/tabs-3.jpg') }}" alt=""
                                    class="img-fluid">
                            </div><!-- End Tab Content Item -->
                        </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4 justify-content-between features-item">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('QuickStart-1.0.0/assets/img/features-1.jpg') }}" class="img-fluid"
                            alt="">
                    </div>
                ...
                <div class="row gy-4 justify-content-between features-item">
                    ...
                    <div class="order-1 col-lg-6 order-lg-2" data-aos="fade-up" data-aos-delay="200">
                        <img src="{{ asset('QuickStart-1.0.0/assets/img/features-2.jpg') }}" class="img-fluid"
                            alt="">
                    </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-around gy-4">
                    ...
                    <div class="order-1 features-image col-lg-5 order-lg-2" data-aos="fade-up" data-aos-delay="200">
                        <img src="{{ asset('QuickStart-1.0.0/assets/img/features-3.jpg') }}" alt="">
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="mt-auto profile">
                                    <img src="{{ asset('QuickStart-1.0.0/assets/img/testimonials/testimonials-1.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="mt-auto profile">
                                    <img src="{{ asset('QuickStart-1.0.0/assets/img/testimonials/testimonials-2.jpg') }}"
                                        class="testimonial-img" alt="">
                                    <h3>Sara Wilsson</h3>
                                    <h4>Designer</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="mt-auto profile">
                                    <img src="{{ asset('QuickStart-1.0.0/assets/img/testimonials/testimonials-3.jpg') }}"
                                        class="testimonial-img" alt="">
                                    <h3>Jena Karlis</h3>
                                    <h4>Store Owner</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="mt-auto profile">
                                    <img src="{{ asset('QuickStart-1.0.0/assets/img/testimonials/testimonials-5.jpg') }}"
                                        class="testimonial-img" alt="">
                                    <h3>John Larson</h3>
                                    <h4>Entrepreneur</h4>
                                </div>
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('QuickStart-1.0.0/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('QuickStart-1.0.0/assets/vendor/php-email-form/validate.js') }}"></script>
    <script src="{{ asset('QuickStart-1.0.0/assets/vendor/aos/aos.js') }}"></script>
    <script src="{{ asset('QuickStart-1.0.0/assets/vendor/glightbox/js/glightbox.min.js') }}"></script>
    <script src="{{ asset('QuickStart-1.0.0/assets/vendor/swiper/swiper-bundle.min.js') }}"></script>

    <!-- Main JS File -->
    <script src="{{ asset('QuickStart-1.0.0/assets/js/main.js') }}"></script>
